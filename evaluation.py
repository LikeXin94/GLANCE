...
def clustering_metric(y_true, y_pred, n_clusters, verbose=True, decimals=4, average='macro'):
    ...
    return dict({'NMI': nmi, 'AMI': ami, 'ARI': ari},  **classification_metrics), confusion_matrix
